	...
	<div class="h-20 mt-6 flex container mx-auto text-3xl">
		...
		<ul class="flex mr-10">
			...
			<c:if test='${rq.getLoginedMemberId() == 0 }'>
				<li class="hover:underline"><a
					class="h-full px-3 flex items-center" href="/usr/member/login"><span>로그인</span></a></li>
			</c:if>
			<c:if test='${rq.getLoginedMemberId() != 0 }'>
				<li class="hover:underline"><a
					class="h-full px-3 flex items-center" href="/usr/member/doLogout"><span>로그아웃</span></a></li>
			</c:if>
		</ul>
		...
		<label class="flex cursor-pointer gap-2"> 
            ...
            <input type="checkbox" value="synthwave"
                class="toggle theme-controller" /> <svg
                xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
	...
	<footer class="footer bg-neutral text-neutral-content p-10">
		...
		<nav>
			...
			<div class="grid grid-flow-col gap-4">
				<a> <svg xmlns="http://www.w3.org/2000/svg" width="24"
          ...
          <path
				...
				</a> <a> <svg xmlns="http://www.w3.org/2000/svg" width="24"
						height="24" viewBox="0 0 24 24" class="fill-current">
          <path
